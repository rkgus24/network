                ...
                <table border="1">
                    ...
                    try{
                        ...
                        String sql =
                            ...
                            "From course_tb1 co, lecturer_tb1 le " +
                        ...
                        String stast = start_hour.substring(0, 2) + "시" + start_hour.substring(2, 4) + "분";
                    ...
                    <tr>
                        <td>
                        <a href="modify.jsp?id=<%=rs.getString(1) %>"></a>
                        </td>
