...
<body>
	...
	<section>
		...
		<form method="post" action="action.jsp" name="frm">
			...
			<table border="1" style="width: 70%; height: 70%; text_align: center">
			<%
			...
			<tr>
				<td>과목명</td>
				<td><input type="text" name="name" style="width:100%" value="<%=name%>" readonly>
				</td>
			</tr>
			<tr>
				<td>학점</td>
				<td><input type="text" name="credit" style="width:100%" value="<%=credit%>" readonly>
				</td>
			</tr>
			<tr>
				<td>담당강사</td>
