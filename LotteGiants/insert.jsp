...
<form action="action.jsp" name="frm" method="POST">
	<table border="1" style="margin:auto">
		...
		<tr>
			<td>선수등급</td>
			<td>
				<input name="pgrade" type="radio" value="S" >S
				<input name="pgrade" type="radio" value="A">A
				<input name="pgrade" type="radio" value="B">B
				<input name="pgrade" type="radio" value="C">C	
			</td>
		</tr>
		<tr>
			<td colspan="2">
				<input type="button" value="수정" onclick="checking2()">
				<input type="button" value="취소" onclick="reseting2()">
			</td>
		</tr>
	</table>
</form>
